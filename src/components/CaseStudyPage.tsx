...
const CaseStudyPage = () => {
  ...
  const projectData: { [key: string]: ProjectDetails } = {
    'atom-learning': {
      ...
      "Throughout, we prototyped and tested designs across digital channels: from landing pages to parent dashboards to school sales decks, ensuring consistency and usability."
      ],
    ...
    'stash-running': {
      ...
      process: [
        ...
        "Each race was treated as a standalone creative experience. They weren't desinged to just be a route to be run, but something different and challenging. I designed races around playful concepts, custom medals, interactive checkpoints, curated playlists, and unexpected twists. Post-race afterparties became as integral to the experience as the race itself, but racing always remained at the fore.",
        "To host the events in their local communities, I collaborated with artists, coffee shops, pubs, and running crews across London. This helped Stash stand out as something more than a race series, and I've been trying to build on that sense of community ever since."],
      tools: ["Community Engagement", "Experience Design", "Social Strategy", "DIY Ethos", "Photography", "Videography",],
      outcome: "I now call Stash a 'Creative Racing Studio.' But, really, what began as a casual meetup has evolved into a sell-out race series with scores of runners and a distinctive following. Stash is now recognized for its aesthetic identity, inclusive energy, and community-first ethos. The impact goes beyond race day. We've built a loyal base that continues to engage through limited merch drops, off-season training groups, and spontaneous local runs. More than a race — it’s become a shared ritual for creative, curious runners across the city.",
      reflection:  "Building Stash Running showed me how much power design thinking has when applied to real-world experiences. Branding wasn’t just a layer, but ended up being the mechanism that made running feel fun, fresh, and accessible again. The biggest insight? You don’t need to be “a runner” to show up. You just need the right invitation.",
    ...
    'buildstuff': {
      ...
      process: ["I developed a high-energy format where participants have just 2–3 hours to conceive and create something tangible based on a surprise theme. The prompts are intentionally strange, open-ended, and split in two halves — forcing participants to interpret, remix, and adapt in real time.",
              "Each sprint includes structured constraints such as limited tools, time boxing, and more — that paradoxically increase creative output. These boundaries create urgency, dissolve hesitation, and lead to surprising outcomes. I continuously evolve the framework based on participant feedback, experimenting with new rules, themes, and group dynamics to keep things fresh and generative.",        
    ...
    'rally': {
      ...
      process: ["The process to building Rally started with user research sessions to identify pain points in social coordination. Using rapid prototyping methods, I tested multiple interaction models to find the simplest possible user flow. The final design incorporated behavioral insights about social commitment and FOMO (fear of missing out) to drive engagement.",
        ...
        "What makes Rally different it how it has embraced casual intent. Instead of rigid start times, formal RSVPs, or location overload, the app leans into ambiguity, encouraging fluid plans and letting people opt in with just one tap. It wasn’t about logistics; it was about permission. The permission to say “I’m free,” without needing to orchestrate everything else."
      ],
    ...
    'ogma-therapy': {
      ...
      challenge: "There are over 75,000 children currently on the NHS waitlist for speech and language therapy. And the tools to help them are outdated. Speech therapy tools have long struggled to strike a balance between clinical depth and user experience. Many existing platforms were either overly technical, frustrating therapists and slowing down their workflow, or they focused too much on gamification, missing the mark on real therapeutic outcomes. Ogma set out to do both. On the therapist side, the goal was to build a trusted AI assistant that could help automate clinical note-taking and progress tracking, ultimately saving time and reducing burnout. On the child-facing side, we aimed to design an engaging, interactive experience led by a virtual character called an Og (get it, OG-ma?), or a “Therapet” that would guide kids through their therapy in a way that felt like play rather than homework.",
      process: ["This project required deep cross-functional collaboration across clinical, technical, and creative domains. I worked at the intersection of:",
        ...
        "For the therapist-facing AI assistant, we ran rounds of feedback and shadowing with SLTs to refine how reports were generated, edited, and stored, ensuring we were reducing cognitive load, instead of adding to it.",
        "For the Og, or Therapet, we prototyped and tested interactive exercises with real children and parents, gathering insights on what kept them engaged and what actually supported therapeutic progress. The design evolved to be adaptive, friendly, and focused on building daily speech habits through gentle nudges and game-like rewards.",],
      ...
      outcome: "Ogma Therapy’s platform launched with two integrated products designed to serve both clinicians and children. The Ogma Assistant, built for therapists, uses AI to generate clinical notes, session summaries, and progress reports in minutes, leading to a (whopping!) 40% reduction in admin time, faster onboarding of new clients, and increased confidence in documentation accuracy. On the child-facing side, the Og became a lovable virtual companion guiding kids through speech exercises in a way that felt playful and motivating. In early trials, the Og drove a demonstrable increase in session engagement and helped children reach their speech goals greater than 18% faster, with many kids genuinely looking forward to their “Og time.",
      reflection: "This was one of the most fulfilling products I’ve worked on in a long time. It blended clinical impact with human-centered design at every step. I also learned that AI isn’t valuable just because it’s powerful — it’s valuable when it disappears into the background and makes people feel supported, seen, and understood. Whether it was helping a therapist save precious hours each week, or designing a virtual pet that could gently encourage a child to try again, the work always came back to the same question: “Does this make therapy feel easier, safer, and more rewarding for the person using it? For Ogma, the answer became yes.",
    },
  };
